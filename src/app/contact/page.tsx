const ContactPage = () => {
  return (
    <div
      className="grid md:grid-cols-2 gap-16 my-10 items-center 
    relative overflow-hidden p-10 
     max-w-6xl mx-auto bg-white text-[#333]  before:absolute before:right-0 
    
    
    before:bg-primary before:h-full max-md:before:hidden"
    >
      <div>
        <div className="grid wrapper sm:grid-cols-2 gap-4 z-20 relative lg:left-16 max-lg:mb-8">
          <div className=" flex box flex-col items-center justify-center rounded w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
            <svg
            ...
            <p className="text-sm text-gray-400 mt-2">
              নাসির সুপার মার্কেট (টাঙ্গাইল রোড) চন্দনা চৌরাস্তা
            </p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center rounded w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
            ...
            <p className="text-sm text-gray-400 mt-2">
              <a href="mailto:sejuti.online@gmail.com">
                sejuti.online@gmail.com
              </a>
            </p>
          </div>
          <div className="box flex flex-col items-center justify-center rounded w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="w-6 fill-primary"
              viewBox="0 0 100 100"
